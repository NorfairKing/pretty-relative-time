...
renderDaysAgoAuto DaysAgo {..} =
  case daysAgoSign of
    GT ->
      if | daysAgoYears > 0 ->
           unwords [ plural daysAgoYears "year" "years", "ago"]
         | daysAgoMonths > 0 ->
           unwords [ plural daysAgoMonths "month" "months", "ago"]
         | daysAgoWeeks > 0 ->
           unwords [ plural daysAgoWeeks "week" "weeks", "ago"]
    ...
    LT ->
      if | daysAgoYears > 0 -> unwords ["in",  plural daysAgoYears "year" "years"]
         | daysAgoMonths > 0 ->
           unwords ["in",  plural daysAgoMonths "month" "months"]
